  ...
  return (
    <div className="py-6 ">
      ...
      <p className="w-full h-[2px]  bg-gray-400">
        <hr className="border-b-[1.5px]  border-orange-500 w-64" />
      </p>
          ...
          <div key={index} className="col-span-1 shadow-lg rounded-lg">
            <div className="text-center">
              ...
              >
                ...
                >
                  <div className="relative border bg-purple-800 border-blue-950 w-full overflow-hidden">
                    <img
                      className={`w-[100%] h-auto rounded-lg duration-700  overflow-hidden${
                        hoveredItemId === item.id ? "hover:scale-105 overflow-hidden" : ""
                      }`}
                      src={hoveredItemId === item.id ? item.img2 : item.img}
                      alt=""
                    />
                    <p className="bg-orange-500 w-16 font-semibold absolute top-2"> -61% </p>
                    <p className="bg-orange-500 w-16 font-semibold absolute top-10"> HOT </p>
                  </div>
                </Link>
              </div>
              <h2>{item.title}</h2>
